 ...
 * Flyway is disabled because no migrations exist yet.
 * WebFlux's WebClient (used for calling the RAG service) wires fine with
 * no running server — it's lazy by design.
 */
@SpringBootTest
